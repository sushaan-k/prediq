...
prediq ingests data from Polymarket, Kalshi, Metaculus, and Manifold Markets, normalizes it into a common schema, and runs analytics to detect cross-exchange price divergences, probability violations, liquidity profiles, and market quality metrics.
...
| Exchange | Markets | Order Book | Historical | WebSocket | Auth |
|---|---|---|---|---|---|
| Polymarket | Binary + Multi | ✅ | ✅ | ✅ | API key |
| Kalshi | Binary | ✅ | ✅ | ✅ | API key |
| Metaculus | Multi + Range | — | ✅ | — | Public |
| Manifold | Binary + Multi | ✅ | ✅ | — | Optional |
...
prediq serve --port 8000
```

`prediq serve` keeps refreshing divergences, violations, liquidity profiles, and quality scores in the background so the API reflects the latest snapshot instead of the startup scan.
...
```bash
git clone https://github.com/sushaan-k/prediq.git
cd prediq
